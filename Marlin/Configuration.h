...
#define CUSTOM_MACHINE_NAME "CR-10S \"Cosmo\""
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -10, -10, 2.6 }
 ...
 */
#define SDSUPPORT
//#define SD_DETECT_PIN -1  // Cosmo may use an SD Card extender that breaks detection
