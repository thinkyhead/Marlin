...
//#define TFT_LVGL_UI
  ...
  #define COLOR_BACKGROUND COLOR_DARK // :['COLOR_BLACK', 'COLOR_DARK']
...
#define TOUCH_SCREEN
  ...
  #define BUTTON_DELAY_MENU     500 // (ms) Button repeat delay for menus
 ...
 */
#define FAN_SOFT_PWM // Any question about this option??
