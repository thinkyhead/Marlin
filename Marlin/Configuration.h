...
#define CUSTOM_MACHINE_NAME "Foo Rex A20M"
 ...
 */
#define EVENT_GCODE_AFTER_G29 "G0X128Y128F8000"
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEVELED_SEGMENT_LENGTH    10    // (mm) Length of all segments (except the last one)
