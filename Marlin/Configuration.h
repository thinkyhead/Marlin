...
#define STRING_CONFIG_H_AUTHOR "(mlee12382, Elegoo Neptune 3)" // Who made the changes.
...
// #define HAS_WIFI              // uncomment if you have wifi module installed, NOT WORKING!
