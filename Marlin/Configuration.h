...
#define BIQU_BX // Flag for pins and code customizations
...
#define STRING_CONFIG_H_AUTHOR "(BIQU, BX)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // BIQU-BX1
    ...
    #define DEFAULT_Kp_LIST { 11.89, 11.89 }
    #define DEFAULT_Ki_LIST {  0.40,  0.40 }
    #define DEFAULT_Kd_LIST { 59.08, 59.08 }
  #else
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 5, 40 }
