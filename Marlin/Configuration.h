...
#define STRING_CONFIG_H_AUTHOR "(thinkyhead, CR-10S)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "CR-10S \"Astro\""
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 2500, 2500, 35, 25 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -48, -5, -0.16 }
...
#define Z_PROBE_ERROR_TOLERANCE     4 // (mm) Tolerance for early trigger (<= -probe.offset.z + ZPET)
