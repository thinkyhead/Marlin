...
#define EXTRUDE_MAXLENGTH 720 // prevent extrusion of very large distances.
...
#define DELTA
  ...
  #define DELTA_HEIGHT 325.00 // get this value from auto calibrate
