...
#define STRING_CONFIG_H_AUTHOR "(thinkyhead, RAMPS Tester)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "RAMPS Tester"
 ...
 *
 * Test your encoder's behavior first with all these options disabled.
 *
