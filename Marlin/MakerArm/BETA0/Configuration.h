...
#define E_GEARBOX_RATIO   3     // Titan extruder 3:1 gearbox
#define E_GEAR_DIAMETER   6.44  // Calibrated 2018-05-18
...
#define DEFAULT_TRAVEL_ACCELERATION     75    // A, B, Z acceleration for travel (non printing) moves
