...
//    fi, an, nl, ca, eu, kana, kana_utf8, cn, cz, el, el-gr, test
=======
//    en, an, bg, ca, cn, cz, de, es, eu, fi, fr, gl, hr, it, kana,
//    kana_utf8, nl, pl, pt, pt_utf8, pt-br, pt-br_utf8, ru, el, el-gr, test
//
// :{'en':'English','an':'Aragonese','bg':'Bulgarian','ca':'Catalan','cn':'Chinese','cz':'Czech','de':'German','es':'Spanish','eu':'Basque-Euskera','fi':'Finnish','fr':'French','gl':'Galician','hr':'Croatian','it':'Italian','kana':'Japanese','kana_utf8':'Japanese (UTF8)','nl':'Dutch','pl':'Polish','pt':'Portuguese','pt-br':'Portuguese (Brazilian)','pt-br_utf8':'Portuguese (Brazilian UTF8)','pt_utf8':'Portuguese (UTF8)','ru':'Russian','el':'Greek','test':'TEST'}
>>>>>>> refs/remotes/upstream/RCBugFix
//
