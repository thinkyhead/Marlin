...
#define STRING_CONFIG_H_AUTHOR "(marcelogaio, SLA)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SLA Printer"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { GALVO_XY_STEPS_MULTIPLIER/GALVOXY_SCALAR, GALVO_XY_STEPS_MULTIPLIER/GALVOXY_SCALAR, 4000, 500 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 8000, 8000, 10, 10 }
...
#define X_MIN_POS -(GALVOXY_X_WIDTH) / 2
#define Y_MIN_POS -(GALVOXY_Y_WIDTH) / 2
#define Z_MIN_POS 0
#define X_MAX_POS (GALVOXY_X_WIDTH) / 2
#define Y_MAX_POS (GALVOXY_Y_WIDTH) / 2
#define Z_MAX_POS GALVOXY_HEIGHT
