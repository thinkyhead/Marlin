...
#define SET_IHOLDDELAY(a) ((a & 0x0F) << 16)
...
/**
 * @brief Activate the driver stage for the given axis
 * @param axis    axis
 * @return  none
 *****************************************************************************/
...
/**
 * @brief Deactivate the driver stage for the given axis
 * @param axis    axis
 * @return  none
 *****************************************************************************/
...
/**
 * @brief Perform a homing for the given axis
