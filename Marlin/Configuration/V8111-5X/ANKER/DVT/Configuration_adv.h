...
#define LIN_ADVANCE
  ...
  #define MAX_EXTRA_K_ACC     420   // (mm/s2) Acceleration of the smoothing algorithm
#endif
...
#define ARC_SUPPORT                   // Requires ~3226 bytes
  ...
  #define MAX_ARC_SEGMENT_MM     12   // (mm) Maximum length of each arc segment
 ...
 */
  ...
  #define SENSORLESS_HOMING   // StallGuard capable drivers only
    ...
    #define Z2_STALL_CURRENT    1200
      ...
      #define ANTHER_TIME_Z_MIN_LIMIT            400   //0.4*10=4mm
      #define ANTHER_TIME_ANTHOR_Z_MAX_LIMIT     1000  //
      #define ANKER_PROBE_TIMEOUT                8000  // If the probe does not trigger for a long time, reset Z to zero ms
      #define ANTHER_Z_DROP_DISTANCE              -14  // drop distance
      #define ANTHER_Z_STEP_DISTANCE               -2  // drop distance
      #define ANTHER_Z_RISE_DISTANCE                2
