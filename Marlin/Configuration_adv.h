...
//
#if ANY(HAS_DGUS_LCD, DGUS_LCD_UI_CREALITY_TOUCH, FORCE10SPRODISPLAY)
...
#if ANY(MachineCR10Orig, SKRMiniE3V2, MachineLargeROM) // Melzi has more SRAM than a 2560
  #define BUFSIZE 16
#else
  #define BUFSIZE 4
#endif
 ...
 */
#if DISABLED(MachineCR10Orig) && !BOTH(SKRMiniE3V2, POWER_LOSS_RECOVERY)
