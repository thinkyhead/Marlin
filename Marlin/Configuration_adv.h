...
#define FT_MOTION
  ...
  #define FTM_SMOOTHING                         // Smoothing can reduce artifacts and make steppers quieter
    ...
    #define FTM_SMOOTHING_TIME_E        0.007f  // (s) Smoothing time for E axis. Prevents noise/skipping from LA by
 ...
 */
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define SENSORLESS_STALLGUARD_DELAY 250 // (ms) Delay to allow drivers to settle
