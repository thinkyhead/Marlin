...
inline int lcd_print(const char* str) { return lcd_printstr(str, PIXEL_LEN_NOLIMIT); }

inline int lcd_print_wchar(wchar_t c) { return lcd_print_uchar(c, PIXEL_LEN_NOLIMIT); }
