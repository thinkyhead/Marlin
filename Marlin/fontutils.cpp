...
int utf8_strlen(const char *pstart) { return utf8_strlen_cb(pstart, read_byte_ram); }

int utf8_strlen_p(const char *pstart) { return utf8_strlen_cb(pstart, read_byte_rom); }
