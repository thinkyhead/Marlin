...
#define MSG_PREHEAT_1_SETTINGS              _UxGT("Definicoes PLA")
...
#define MSG_PREHEAT_2_SETTINGS              _UxGT("Definicoes ABS")
...
#define MSG_NOZZLE                          LCD_STR_THERMOMETER _UxGT(" Bico")
...
#define MSG_A_RETRACT                       _UxGT("A-retraccao")
...
#define MSG_RESUME_PRINT                    _UxGT("Retomar impressao")
...
#define MSG_USERWAIT                        _UxGT("A espera de ordem")
#define MSG_RESUMING                        _UxGT("Retomando impressao")
#define MSG_PRINT_ABORTED                   _UxGT("Impressao cancelada")
#define MSG_NO_MOVE                         _UxGT("Sem movimento")
#define MSG_KILLED                          _UxGT("EMERGENCIA. ")
...
#define MSG_INIT_SDCARD                     _UxGT("Inici. cartao SD")
#define MSG_CNG_SDCARD                      _UxGT("Trocar cartao SD")
...
#define MSG_ERR_MAXTEMP                     _UxGT("Err: T Maxima")
#define MSG_ERR_MINTEMP                     _UxGT("Err: T Minima")
#define MSG_ERR_MAXTEMP_BED                 _UxGT("Err: T Base Maxima")
#define MSG_ERR_MINTEMP_BED                 _UxGT("Err: T Base Minima")
...
#define MSG_DELTA_CALIBRATE                 _UxGT("Calibracao Delta")
