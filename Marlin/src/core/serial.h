...
extern const char NUL_STR[], SP_P_STR[], SP_T_STR[],
                  ...
                  SP_X_STR[], SP_Y_STR[], SP_Z_STR[], SP_I_STR[], SP_J_STR[], SP_K_STR[], SP_M_STR[], SP_O_STR[], SP_Q_STR[], SP_E_STR[],
                  SP_X_LBL[], SP_Y_LBL[], SP_Z_LBL[], SP_I_LBL[], SP_J_LBL[], SP_K_LBL[], SP_M_LBL[], SP_O_LBL[], SP_Q_LBL[], SP_E_LBL[],
                  X_STR[], Y_STR[], Z_STR[], I_STR[], J_STR[], K_STR[], M_STR[], O_STR[], Q_STR[], E_STR[],
                  X_LBL[], Y_LBL[], Z_LBL[], I_LBL[], J_LBL[], K_LBL[], M_LBL[], O_LBL[], Q_LBL[], E_LBL[];
