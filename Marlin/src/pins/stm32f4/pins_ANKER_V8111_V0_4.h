...
#define BOARD_INFO_NAME "Anker V8111 0.4"
#define BOARD_WEBSITE_URL "github.com/Anker"

// Set a flag for features.ini. Assume this board is always in an AnkerMake printer.
#define ANKER_MAKE
...
#define STEP_TIMER                            10
  ...
  #define PROBE_CONTROL_PIN                 PC10
  #define PROBE_CONTROL_STATE               HIGH
  ...
  #define ANKER_NOZZLE_BOARD_DEFAULT_THRESHOLD400
  #define ANKER_Z_SENSORLESS_PROBE_VALUE     800
  #define ANKER_NOZZLE_BOARD_DEFAULT_FIREPROOF0195//0--255   195--70C   208--60
  #define ANKER_NOZZLE_BOARD_DEFAULT_FIREPROOF1195
#endif
  ...
  #define ANKER_LEVELING_DELAY_BEFORE_PROBING_TRUE100//1000
  #define ANKER_LEVELING_DELAY_BEFORE_PROBING500  //5000
#endif
...
// [SRL] TODO: Move to configuration
  ...
  #define ANKER_HOMING_SCRIPT_RELATIVE "G92 E0\nG1 X200 Y237 E10 F3000\nG1 X117.5 Y236.2 E5 F3000\nG1 E-10 F3600\nG92 E0\n"
  #define PROBE_HOMING_BUMP_MM      { 0, 0, 2 }
#endif

#if ENABLED(ANKER_ALIGN)
 #define ALIGN_PER_RESET
 #define ALIGN_RISE                            1  //ascent
 #define ALIGN_NUM                             6
 #define ALIGN_ALLOWED  0.1  //Error allowed
 #define ALIGN_MAX_VALUE                       2
