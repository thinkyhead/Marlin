...
#define STEP_TIMER                            10
  ...
  // Z Probe (when not Z_MIN_PIN)
     ...
     #if ANKER_MACHINE == MOTOR_5X_DVT_USE_G_SENSOR
  ...
  #define ANKER_LEVELING_DELAY_BEFORE_PROBING_TRUE  100//1000
  #define ANKER_LEVELING_DELAY_BEFORE_PROBING  500//5000
#endif
...
#if ENABLED(ANKER_ALIGN)                          // NOZZLE_TYPE_OLD <= v8111-auto-level-v0_5
 #define ALIGN_PER_RESET
 #define ALIGN_RISE 1       //ascent
 #define ALIGN_NUM  6
 #define ALIGN_ALLOWED  0.09//0.1  //Error allowed
...
// NOZZLE_TYPE_NEW >= v8111-auto-level-v0_7
  ...
  #define NOZZLE_TYPE_NEW_ALIGN_ALLOWED  0.08//0.1  //Error allowed
#endif
