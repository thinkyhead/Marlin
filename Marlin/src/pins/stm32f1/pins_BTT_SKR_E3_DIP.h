...
#define TFT_03                              PA2
  ...
  #define FORCE_SOFT_SPI
    ...
    #ifndef NO_CONTROLLER_CUSTOM_WIRING_WARNING
      #error "CAUTION! FYSETC_MINI_12864_2_1 and it's clones require wiring modifications. See 'adapters.h' for details. (Define NO_CONTROLLER_CUSTOM_WIRING_WARNING to suppress this warning.)"
    #endif
    ...
    #define ADAPTER_CUSTOM_E3_DIP_TFT
