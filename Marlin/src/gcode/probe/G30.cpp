 ...
 */
void GcodeSuite::G30() {
  const float xpos = parser.linearval('X', tool.position[X_AXIS] + X_PROBE_OFFSET_FROM_EXTRUDER),
              ypos = parser.linearval('Y', tool.position[Y_AXIS] + Y_PROBE_OFFSET_FROM_EXTRUDER);
