...
#define LISTITEM_WIDTH    (BTT_LCD_WIDTH-(3*START_X)-LIST_ICON_WIDTH)
#define LISTITEM_HEIGHT   ((BTT_LCD_HEIGHT-ICON_START_Y-START_X)/5)
#define LISTICON_SPACE_Y  ((BTT_LCD_HEIGHT-ICON_START_Y-START_X-(3*LIST_ICON_HEIGHT))/ 2)
