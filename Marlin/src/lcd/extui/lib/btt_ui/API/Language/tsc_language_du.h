...
#pragma once
    ...
    #define DU_BED_LEVELING           "Bed Level"
    #define DU_BL_COMPLETE            "Bed Leveling voltooid"
    #define DU_BL_SMART_FILL          "Missende probe punten\nzijn slim opgevuld.\n \nNote: Vergeet niet op te slaan!"
    #define DU_BL_ENABLE              "BL: aan"
    #define DU_BL_DISABLE             "BL: uit"
    #define DU_ABL                    "ABL"
    #define DU_BBL                    "BBL"
    #define DU_UBL                    "UBL"
    #define DU_MBL                    "MBL"
    #define DU_MBL_SETTINGS           "Mesh Bed Leveling"
    #define DU_ABL_SETTINGS           "Auto Bed Leveling"
    #define DU_ABL_SETTINGS_BBL       "Bilinear Bed Leveling"
    ...
    #define DU_TUNE_EXTRUDER          "Tune steps"
    #define DU_TUNE_EXT_EXTRUDE_100   "Ext. 100mm"
