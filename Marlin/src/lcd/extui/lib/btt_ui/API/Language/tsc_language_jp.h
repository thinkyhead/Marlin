...
#pragma once
    ...
    #define JP_SOUND                  "Sound"
    #define JP_TOUCH_SOUND            "Touch sounds"
    #define JP_TOAST_SOUND             "Toast Notifications"
    #define JP_ALERT_SOUND            "Popups and Alerts"
    ...
    #define JP_BED_LEVELING           "Bed Level"
    #define JP_BL_COMPLETE            "Bed Leveling Complete"
    #define JP_BL_SMART_FILL          "Missing probe points\nhave been smart filled.\n \nNote: remember to save!"
    #define JP_BL_ENABLE              "BL: on"
    #define JP_BL_DISABLE             "BL: off"
    #define JP_ABL                    "自動調整"
    #define JP_BBL                    "BBL"
    #define JP_UBL                    "UBL"
    #define JP_MBL                    "MBL"
    #define JP_MBL_SETTINGS           "Mesh Bed Leveling"
    #define JP_ABL_SETTINGS           "Auto Bed Leveling"
    #define JP_ABL_SETTINGS_BBL       "Bilinear Bed Leveling"
    ...
    #define JP_PID_START_INFO         "PID autotune may take\nsome time to complete.\nContinue?"
    ...
    #define JP_TUNE_EXTRUDER          "Tune steps"
    #define JP_TUNE_EXT_EXTRUDE_100   "Ext. 100mm"
    #define JP_TUNE_EXT_TEMP          "Extruder tuning | Heat"
    #define JP_TUNE_EXT_TEMPLOW       "Desired temperature too low!\nMinimum temperature: %d C"
    #define JP_TUNE_EXT_DESIREDVAL    "Temperature is not yet at the desired value"
    #define JP_TUNE_EXT_MARK120MM     "Mark 120 mm on your fillament\nPress '%s' when ready\nMeasure remaining length\nafter extruding"
    #define JP_TUNE_EXT_HEATOFF       "Turn the heater off?"
    #define JP_TUNE_EXT_ADJ_ESTEPS    "Adjust E-Steps"
    #define JP_TUNE_EXT_ESTEPS_SAVED  "New E-steps saved!\nDon't forget to\nsave it in EEPROM\nNew value: %0.2f"
    #define JP_TUNE_EXT_MEASURED      "Length remaining:"
