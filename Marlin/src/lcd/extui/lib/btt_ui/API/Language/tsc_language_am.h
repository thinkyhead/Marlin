...
#pragma once
    ...
    #define AM_BED_LEVELING           "Bed Level"
    #define AM_BL_COMPLETE            "Bed Leveling Complete"
    #define AM_BL_SMART_FILL          "Missing probe points\nhave been smart filled.\n \nNote: remember to save!"
    #define AM_BL_ENABLE              "BL: on"
    #define AM_BL_DISABLE             "BL: off"
    #define AM_ABL                    "ABL"
    #define AM_BBL                    "BBL"
    #define AM_UBL                    "UBL"
    #define AM_MBL                    "MBL"
    #define AM_MBL_SETTINGS           "Mesh Bed Leveling"
    #define AM_ABL_SETTINGS           "Auto Bed Leveling"
    #define AM_ABL_SETTINGS_BBL       "Bilinear Bed Leveling"
    ...
    #define AM_TUNE_EXTRUDER          "Tune steps"
    #define AM_TUNE_EXT_EXTRUDE_100   "Ext. 100mm"
    #define AM_TUNE_EXT_TEMP          "Extruder tuning | Heat"
    #define AM_TUNE_EXT_TEMPLOW       "Desired temperature too low!\nMinimum temperature: %d C"
    #define AM_TUNE_EXT_DESIREDVAL    "Temperature is not yet at the desired value"
    #define AM_TUNE_EXT_MARK120MM     "Mark 120 mm on your fillament\nPress '%s' when ready\nMeasure remaining length\nafter extruding"
    #define AM_TUNE_EXT_HEATOFF       "Turn the heater off?"
    #define AM_TUNE_EXT_ADJ_ESTEPS    "Adjust E-Steps"
    #define AM_TUNE_EXT_ESTEPS_SAVED  "New E-steps saved!\nDon't forget to\nsave it in EEPROM\nNew value: %0.2f"
    #define AM_TUNE_EXT_MEASURED      "Length remaining:"
