...
#pragma once
    ...
    #define CZ_SCREEN_SETTINGS        "Displej"
    #define CZ_MACHINE_SETTINGS       "Tiskárna"
    #define CZ_FEATURE_SETTINGS       "Vlastnosti"
    #define CZ_SOUND                  "Zvuk"
    #define CZ_TOUCH_SOUND            "Zvuk při dotyku"
    #define CZ_TOAST_SOUND            "Zvuk vytápění"
    #define CZ_ALERT_SOUND            "Upozornění, popup okno"
    #define CZ_SHUT_DOWN              "Vypnout"
    #define CZ_RGB_SETTINGS           "Barva LED"
    #define CZ_RGB_OFF                "LED vyp."
    #define CZ_TERMINAL               "Terminál"
    ...
    #define CZ_BED_LEVELING           "Bed Level"
    #define CZ_BL_COMPLETE            "Vyrovnání kompletní"
    #define CZ_BL_SMART_FILL          "Chybějící body sondy\nbyly vyplněny inteligentně.\n \nPozn: Nezapomeň uložit!"
    #define CZ_BL_ENABLE              "BL: on"
    #define CZ_BL_DISABLE             "BL: off"
    #define CZ_ABL                    "Vyrovnat"
    #define CZ_BBL                    "BBL"
    #define CZ_UBL                    "UBL"
    #define CZ_MBL                    "MBL"
    #define CZ_MBL_SETTINGS           "Mesh Bed Leveling"
    #define CZ_ABL_SETTINGS           "Auto Bed Leveling"
    #define CZ_ABL_SETTINGS_BBL       "Bilineární vyrovnání"
    ...
    #define CZ_PROBE_OFFSET           "Offset sondy"
    ...
    #define CZ_TOUCHSCREEN_ADJUST     "Kalibrovat"
    #define CZ_MORE                   "Více"
    ...
    #define CZ_AUTO_SHUT_DOWN         "Auto.vypnutí"
    ...
    #define CZ_TERMINAL_ACK           "zobrazit ACK Terminálu"
    ...
    #define CZ_TUNE_EXT_DESIREDVAL    "Teplota ještě není na požadované hodnotě"
    #define CZ_TUNE_EXT_MARK120MM     "Označ 120mm on fillamentu\nStlač '%s' pokud jsi připraven.\nZměř zbývající délku\npo vytlačení."
    #define CZ_TUNE_EXT_HEATOFF       "Vypnout topení?"
    #define CZ_TUNE_EXT_ADJ_ESTEPS    "Nastavení E-Kroků"
    #define CZ_TUNE_EXT_ESTEPS_SAVED  "Nové E-kroky uloženy!\nNezapmeň \nuložit do EEPROM.\nNová hodnota: %0.2f"
    #define CZ_TUNE_EXT_MEASURED      "Zbývající délka:"
