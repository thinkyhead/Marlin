...
#pragma once
    ...
    #define PT_BED_LEVELING           "Bed Level"
    #define PT_BL_COMPLETE            "Bed Leveling Complete"
    #define PT_BL_SMART_FILL          "Missing probe points\nhave been smart filled.\n \nNote: remember to save!"
    #define PT_BL_ENABLE              "BL: on"
    #define PT_BL_DISABLE             "BL: off"
    #define PT_ABL                    "ABL"
    #define PT_BBL                    "BBL"
    #define PT_UBL                    "UBL"
    #define PT_MBL                    "MBL"
    #define PT_MBL_SETTINGS           "Mesh Bed Leveling"
    #define PT_ABL_SETTINGS           "Auto Bed Leveling"
    #define PT_ABL_SETTINGS_BBL       "Bilinear Bed Leveling"
