...
#pragma once
    ...
    #define TC_BED_LEVELING           "Bed Level"
    #define TC_BL_COMPLETE            "平臺調平完成!"
    #define TC_BL_SMART_FILL          "部分點未探測，已被自動填充，需要手動保存!"
    #define TC_BL_ENABLE              "BL:已開啟"
    #define TC_BL_DISABLE             "BL:已關閉"
    #define TC_ABL                    "自動調平"
    #define TC_BBL                    "BBL"
    #define TC_UBL                    "UBL"
    #define TC_MBL                    "MBL"
    #define TC_MBL_SETTINGS           "Mesh Bed Leveling"
    #define TC_ABL_SETTINGS           "Auto Bed Leveling"
    #define TC_ABL_SETTINGS_BBL       "Bilinear Bed Leveling"
