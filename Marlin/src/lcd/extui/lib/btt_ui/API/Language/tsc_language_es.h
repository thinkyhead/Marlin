...
#pragma once
    ...
    #define ES_SOUND                  "Sound"
    #define ES_TOUCH_SOUND            "Touch sounds"
    #define ES_TOAST_SOUND            "Toast Notifications"
    #define ES_ALERT_SOUND            "Popups and Alerts"
    ...
    #define ES_BED_LEVELING           "Bed Level"
    #define ES_BL_COMPLETE            "Bed Leveling Complete"
    #define ES_BL_SMART_FILL          "Missing probe points\nhave been smart filled.\n \nNote: remember to save!"
    #define ES_BL_ENABLE              "BL: on"
    #define ES_BL_DISABLE             "BL: off"
    #define ES_ABL                    "ABL"
    #define ES_BBL                    "BBL"
    #define ES_UBL                    "UBL"
    #define ES_MBL                    "MBL"
    #define ES_MBL_SETTINGS           "Mesh Bed Leveling"
    #define ES_ABL_SETTINGS           "Auto Bed Leveling"
    #define ES_ABL_SETTINGS_BBL       "Bilinear Bed Leveling"
    ...
    #define ES_ACK_NOTIFICATION       "ACK notification style"
    ...
    #define ES_PID_START_INFO         "PID autotune may take\nsome time to complete.\nContinue?"
    ...
    #define ES_TUNE_EXTRUDER          "Tune steps"
    #define ES_TUNE_EXT_EXTRUDE_100   "Ext. 100mm"
    #define ES_TUNE_EXT_TEMP          "Extruder tuning | Heat"
    #define ES_TUNE_EXT_TEMPLOW       "Desired temperature too low!\nMinimum temperature: %d C"
    #define ES_TUNE_EXT_DESIREDVAL    "Temperature is not yet at the desired value"
    #define ES_TUNE_EXT_MARK120MM     "Mark 120 mm on your fillament\nPress '%s' when ready\nMeasure remaining length\nafter extruding"
    #define ES_TUNE_EXT_HEATOFF       "Turn the heater off?"
    #define ES_TUNE_EXT_ADJ_ESTEPS    "Adjust E-Steps"
    #define ES_TUNE_EXT_ESTEPS_SAVED  "New E-steps saved!\nDon't forget to\nsave it in EEPROM\nNew value: %0.2f"
    #define ES_TUNE_EXT_MEASURED      "Length remaining:"
