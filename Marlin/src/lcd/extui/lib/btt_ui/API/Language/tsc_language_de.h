...
#pragma once
    ...
    #define DE_BED_LEVELING           "Bed Level"
    #define DE_BL_COMPLETE            "Bed Leveling Complete"
    #define DE_BL_SMART_FILL          "Missing probe points\nhave been smart filled.\n \nNote: remember to save!"
    #define DE_BL_ENABLE              "BL: on"
    #define DE_BL_DISABLE             "BL: off"
    #define DE_ABL                    "ABL"
    #define DE_BBL                    "BBL"
    #define DE_UBL                    "UBL"
    #define DE_MBL                    "MBL"
    #define DE_MBL_SETTINGS           "Mesh Bed Leveling"
    #define DE_ABL_SETTINGS           "Auto Bed Leveling"
    #define DE_ABL_SETTINGS_BBL       "Bilinear Bed Leveling"
