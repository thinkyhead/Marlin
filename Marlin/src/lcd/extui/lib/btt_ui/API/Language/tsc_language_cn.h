...
#pragma once
    ...
    #define CN_SOUND                  "声音"
    #define CN_TOUCH_SOUND            "按钮声音"
    #define CN_TOAST_SOUND            "Toast 提示声音"
    #define CN_ALERT_SOUND            "弹窗和提示声音"
    ...
    #define CN_BED_LEVELING           "Bed Level"
    #define CN_BL_COMPLETE            "平台调平完成!"
    #define CN_BL_SMART_FILL          "部分点未探测,已被自动填充, 需要手动保存!"
    #define CN_BL_ENABLE              "BL:已开启"
    #define CN_BL_DISABLE             "BL:已关闭"
    #define CN_ABL                    "自动调平"
    #define CN_BBL                    "BBL"
    #define CN_UBL                    "UBL"
    #define CN_MBL                    "MBL"
    #define CN_MBL_SETTINGS           "Mesh Bed Leveling"
    #define CN_ABL_SETTINGS           "Auto Bed Leveling"
    #define CN_ABL_SETTINGS_BBL       "Bilinear Bed Leveling"
    ...
    #define CN_OFF                    "关闭"
    #define CN_SMART                  "智能"
    #define CN_TERMINAL_ACK           "在G-code终端中显示温度信息"
    ...
    #define CN_EEPROM_SETTINGS        "EEPROM"
    ...
    #define CN_TUNE_EXTRUDER          "微调E-Steps"
    #define CN_TUNE_EXT_EXTRUDE_100   "挤出100mm"
    #define CN_TUNE_EXT_TEMP          "挤出机微调 | 加热"
    #define CN_TUNE_EXT_TEMPLOW       "目标温度太低,最低温度为: %d℃"
    #define CN_TUNE_EXT_DESIREDVAL    "实际温度还没达到设定值"
    #define CN_TUNE_EXT_MARK120MM     "在耗材上标记120mm\n标记完成后点击 '%s'\n挤出完成后测量剩余长度"
    #define CN_TUNE_EXT_HEATOFF       "关闭加热?"
    #define CN_TUNE_EXT_ADJ_ESTEPS    "调整E-Steps"
    #define CN_TUNE_EXT_ESTEPS_SAVED  "新的E-Steps已生效,需要手动保存到EEPROM\n新E-Steps: %0.2f"
    #define CN_TUNE_EXT_MEASURED      "剩余的长度:"
