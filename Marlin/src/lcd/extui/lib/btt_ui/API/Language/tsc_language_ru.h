...
#pragma once
    ...
    #define RU_BED_LEVELING           "Bed Level"
    #define RU_BL_COMPLETE            "Выравнивание стола окончено"
    #define RU_BL_SMART_FILL          "Отсутствующие точки\nзамера были атоматически\nзаполнены.\nЗапомните для сохраниения!"
    #define RU_BL_ENABLE              "BL: вкл"
    #define RU_BL_DISABLE             "BL: выкл"
    #define RU_ABL                    "ABL"
    #define RU_BBL                    "BBL"
    #define RU_UBL                    "UBL"
    #define RU_MBL                    "MBL"
    #define RU_MBL_SETTINGS           "Mesh Bed Leveling"
    #define RU_ABL_SETTINGS           "Auto Bed Leveling"
    #define RU_ABL_SETTINGS_BBL       "Билинейная калибровка"
    ...
    #define RU_ACK_NOTIFICATION       "ACK стиль уведомления"
    #define RU_LEVELING_EDGE_DISTANCE "Отступы от краёв стола"
    #define RU_XY_UNLOCK              "XY отпуск"
    ...
    #define RU_TUNE_EXT_EXTRUDE_100   "100mm экст."
