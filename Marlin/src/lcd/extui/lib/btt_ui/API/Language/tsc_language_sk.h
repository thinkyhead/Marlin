...
#pragma once
    ...
    #define SK_SOUND                  "Sound"
    #define SK_TOUCH_SOUND            "Touch sounds"
    #define SK_TOAST_SOUND            "Toast Notifications"
    #define SK_ALERT_SOUND            "Popups and Alerts"
    ...
    #define SK_BED_LEVELING           "Bed Level"
    #define SK_BL_COMPLETE            "Bed Leveling Complete"
    #define SK_BL_SMART_FILL          "Missing probe points\nhave been smart filled.\n \nNote: remember to save!"
    #define SK_BL_ENABLE              "BL: on"
    #define SK_BL_DISABLE             "BL: off"
    #define SK_ABL                    "ABL"
    #define SK_BBL                    "BBL"
    #define SK_UBL                    "UBL"
    #define SK_MBL                    "MBL"
    #define SK_MBL_SETTINGS           "Mesh Bed Leveling"
    #define SK_ABL_SETTINGS           "Auto Bed Leveling"
    #define SK_ABL_SETTINGS_BBL       "Bilinear Bed Leveling"
    ...
    #define SK_ACK_NOTIFICATION       "ACK notification style"
    ...
    #define SK_PID_START_INFO         "PID autotune may take\nsome time to complete.\nContinue?"
    ...
    #define SK_TUNE_EXTRUDER          "Tune steps"
    #define SK_TUNE_EXT_EXTRUDE_100   "Ext. 100mm"
    #define SK_TUNE_EXT_TEMP          "Extruder tuning | Heat"
    #define SK_TUNE_EXT_TEMPLOW       "Desired temperature too low!\nMinimum temperature: %d C"
    #define SK_TUNE_EXT_DESIREDVAL    "Temperature is not yet at the desired value"
    #define SK_TUNE_EXT_MARK120MM     "Mark 120 mm on your fillament\nPress '%s' when ready\nMeasure remaining length\nafter extruding"
    #define SK_TUNE_EXT_HEATOFF       "Turn the heater off?"
    #define SK_TUNE_EXT_ADJ_ESTEPS    "Adjust E-Steps"
    #define SK_TUNE_EXT_ESTEPS_SAVED  "New E-steps saved!\nDon't forget to\nsave it in EEPROM\nNew value: %0.2f"
    #define SK_TUNE_EXT_MEASURED      "Length remaining:"
