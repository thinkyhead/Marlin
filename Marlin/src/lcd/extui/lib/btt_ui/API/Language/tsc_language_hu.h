...
#pragma once
    ...
    #define HU_BED_LEVELING           "Bed Level"
    #define HU_BL_COMPLETE            "Ágy Szintezés Sikeres"
    #define HU_BL_SMART_FILL          "A hiányzó szonda pontok\nkitöltésre kerültek.\nMegjegyzés: Mentsd el!"
    #define HU_BL_ENABLE              "BL: be"
    #define HU_BL_DISABLE             "BL: ki"
    #define HU_ABL                    "ABL"
    #define HU_BBL                    "BBL"
    #define HU_UBL                    "UBL"
    #define HU_MBL                    "MBL"
    #define HU_MBL_SETTINGS           "Mesh Bed Leveling"
    #define HU_ABL_SETTINGS           "Auto Bed Leveling"
    #define HU_ABL_SETTINGS_BBL       "Bilineáris Ágyszintezés"
    ...
    #define HU_MAGENTA                "Bíborvörös"
    #define HU_PURPLE                 "Lila"
    #define HU_LIME                   "Mész"
    ...
    #define HU_TUNE_EXTRUDER          "Lépés hangolás"
    #define HU_TUNE_EXT_EXTRUDE_100   "Kiad 100mm"
    #define HU_TUNE_EXT_TEMP          "Adagoló hangolás | Fűt"
    #define HU_TUNE_EXT_TEMPLOW       "Túl alacsony a kívánt hőfok!\nMinimum temperature: %d C"
    #define HU_TUNE_EXT_DESIREDVAL    "A hőfok még nem érte el a kívánt értéket"
    #define HU_TUNE_EXT_MARK120MM     "A 120mm-t jelöld be a szálon\nNyomd '%s' ha kész\nMérd meg a hátralévő hosszt\nadagolás után."
    #define HU_TUNE_EXT_HEATOFF       "Kikapcsolod a fűtést?"
    #define HU_TUNE_EXT_ADJ_ESTEPS    "Állítható E-lépés"
    #define HU_TUNE_EXT_ESTEPS_SAVED  "Új E-lépés mentve!\nNe felejtsd el\nmenteni EEPROM-ba.\nÚj érték: %0.2f"
    #define HU_TUNE_EXT_MEASURED      "Fennmaradó Hossz:"
