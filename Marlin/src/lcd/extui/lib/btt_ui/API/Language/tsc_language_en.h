...
#pragma once
    ...
    #define EN_BED_LEVELING           "Bed Level"
    #define EN_BL_COMPLETE            "Bed Leveling Complete"
    #define EN_BL_SMART_FILL          "Missing probe points\nhave been smart filled.\n \nNote: remember to save!"
    #define EN_BL_ENABLE              "BL: on"
    #define EN_BL_DISABLE             "BL: off"
    #define EN_ABL                    "ABL"
    #define EN_BBL                    "BBL"
    #define EN_UBL                    "UBL"
    #define EN_MBL                    "MBL"
    #define EN_MBL_SETTINGS           "Mesh Bed Leveling"
    #define EN_ABL_SETTINGS           "Auto Bed Leveling"
    #define EN_ABL_SETTINGS_BBL       "Bilinear Bed Leveling"
