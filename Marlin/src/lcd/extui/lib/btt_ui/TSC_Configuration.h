 ...
 */
#define DEFAULT_LCD_MODE LCD_MODE_SERIAL_TSC
 ...
 */
#define DEFAULT_LANGUAGE TSC_ENGLISH
...
#define LEVELING_POINT_XY_FEEDRATE 4800  // (mm/min) X and Y axes move feedrate
