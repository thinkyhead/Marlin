...
void menuBLTouchCallBack(void) {
  KEY_VALUES key_num = menuKeyGetValue();
  switch(key_num) {
    case KEY_ICON_0: storeCmd("M280 P0 S160\n"); break;
    case KEY_ICON_1: storeCmd("M280 P0 S120\n"); break;
    case KEY_ICON_2: storeCmd("M280 P0 S10\n");  break;
    case KEY_ICON_3: storeCmd("M280 P0 S90\n");  break;
    case KEY_ICON_4: storeCmd("G28\n"); storeCmd("M48\n"); break;
...
void menuBLTouch(void) {
  ...
  menuSetFrontCallBack(menuBLTouchCallBack);
}
