...
#define BTT_LCD_WIDTH   480
#define BTT_LCD_HEIGHT  272
...
#define POPUP_RECT_SINGLE_CONFIRM {180, BTT_LCD_HEIGHT- SPACE_Y - 10 - POPUP_BUTTON_HEIGHT, 300, BTT_LCD_HEIGHT - SPACE_Y - 10}
#define POPUP_RECT_DOUBLE_CONFIRM {90,  BTT_LCD_HEIGHT- SPACE_Y - 10 - POPUP_BUTTON_HEIGHT, 210, BTT_LCD_HEIGHT - SPACE_Y - 10}
#define POPUP_RECT_DOUBLE_CANCEL  {270, BTT_LCD_HEIGHT- SPACE_Y - 10 - POPUP_BUTTON_HEIGHT, 390, BTT_LCD_HEIGHT - SPACE_Y - 10}
