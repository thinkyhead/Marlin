...
#define BTT_LCD_WIDTH   800
#define BTT_LCD_HEIGHT  480
...
// Popup menu
#define POPUP_RECT_WINDOW         {SPACE_X*2, TITLE_END_Y, BTT_LCD_WIDTH - SPACE_X*2, BTT_LCD_HEIGHT - SPACE_Y}
#define POPUP_TITLE_HEIGHT        80
#define POPUP_BOTTOM_HEIGHT       105
#define POPUP_BUTTON_HEIGHT       75
#define POPUP_RECT_SINGLE_CONFIRM {320, BTT_LCD_HEIGHT- SPACE_Y - 10 - POPUP_BUTTON_HEIGHT, 480, BTT_LCD_HEIGHT - SPACE_Y - 10}
#define POPUP_RECT_DOUBLE_CONFIRM {140, BTT_LCD_HEIGHT- SPACE_Y - 10 - POPUP_BUTTON_HEIGHT, 300, BTT_LCD_HEIGHT - SPACE_Y - 10}
#define POPUP_RECT_DOUBLE_CANCEL  {500, BTT_LCD_HEIGHT- SPACE_Y - 10 - POPUP_BUTTON_HEIGHT, 660, BTT_LCD_HEIGHT - SPACE_Y - 10}
