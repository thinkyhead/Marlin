...
#define BTT_LCD_WIDTH   320
#define BTT_LCD_HEIGHT  240
...
#define POPUP_RECT_SINGLE_CONFIRM {110, BTT_LCD_HEIGHT- SPACE_Y - 5 - POPUP_BUTTON_HEIGHT, 210, BTT_LCD_HEIGHT - SPACE_Y - 5}
#define POPUP_RECT_DOUBLE_CONFIRM {40,  BTT_LCD_HEIGHT- SPACE_Y - 5 - POPUP_BUTTON_HEIGHT, 140, BTT_LCD_HEIGHT - SPACE_Y - 5}
#define POPUP_RECT_DOUBLE_CANCEL  {180, BTT_LCD_HEIGHT- SPACE_Y - 5 - POPUP_BUTTON_HEIGHT, 280, BTT_LCD_HEIGHT - SPACE_Y - 5}
