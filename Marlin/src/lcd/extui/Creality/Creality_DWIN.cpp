...
#include "../ui_api.h"
  ...
  void onIdle() {
    ...
    if (awaitingUserConfirm() && lastPauseMsgState != ExtUI::pauseModeStatus) {
      switch (ExtUI::pauseModeStatus) {
        ...
        case PAUSE_MESSAGE_PURGE:
          ExtUI::onUserConfirmRequired(GET_TEXT_F(
    ...
    if (NozzleTempStatus[0] || NozzleTempStatus[2]) { // statuses of loadfilement and unloadfinement when temperature is less than
