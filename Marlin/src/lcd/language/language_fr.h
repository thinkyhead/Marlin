...
namespace Language_fr {
  ...
  LSTR MSG_AUTO_HOME_I                    = _UxGT("Origine ") STR_I _UxGT(" auto");
  LSTR MSG_AUTO_HOME_J                    = _UxGT("Origine ") STR_J _UxGT(" auto");
  LSTR MSG_AUTO_HOME_K                    = _UxGT("Origine ") STR_K _UxGT(" auto");
