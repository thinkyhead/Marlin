...
// Profile selection
#define ANKER_MACHINE   MOTOR_5X_DVT
// Motherboard temperature sensor configuration
#if (ANKER_MACHINE >= 1000) && (ANKER_MACHINE < 2000)   // USE 5X
  #define ANKER_MACHINE_ID MACHINE_5X_ID
#endif
...
#if HANDSHAKE
  #if PROBE_CONTROL == 0
    #error "HANDSHAKE needs to be enabled PROBE_CONTROL"
  #endif
