...
#define MACHINE_5X_ID                     1000
#define MOTOR_5X_DVT                       1200

//Profile selection
#define MACHINE   MOTOR_5X_DVT
//Motherboard temperature sensor configuration
#if MACHINE >=1000 && MACHINE < 2000   // USE 5X
  #define MACHINE_ID MACHINE_5X_ID
#endif
/*******************************Functional API Configuration****************************/
#if MACHINE == MOTOR_5X_DVT
  #ifndef SHORT_BUILD_VERSION
    #define SHORT_BUILD_VERSION    "V8111_V2.0.40"
  #endif
  #define ANKER_MAKE_API           1 //gcode
  #define ANKER_GCODE_CHECK        0
  #define PROBE_CONTROL            1
  ...
  #define ANKER_MULTIORDER_PACK    1 //Anker multi order in one packet in once communication
  #define ANKER_LEVELING           1 //Leveling Correction Program
  #define ANKER_LEVELING_FADE      1
  #define ANKER_ALIGN              1 //Z axis automatic alignment
  ...
  #define ANKER_FIX_ENDSTOPS       1 //Used to resolve limit switch conflicts on motherboards
  ...
  #define ANKER_PRINT_SLOWDOWN     1 //this is for the machine to prevent to print slowdown
...
#if HANDSHAKE
  #if PROBE_CONTROL == 0
    #error "HANDSHAKE must be enabled for PROBE_CONTROL."
  #endif
  #if HEATER_EN_CONTROL == 0
    #error "HANDSHAKE must be enabled for HEATER_EN_CONTROL."
  #endif
#endif
