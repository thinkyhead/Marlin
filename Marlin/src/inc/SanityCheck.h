 ...
 */
  ...
  + ENABLED(MKS_TS35_V2_0) \
  + ENABLED(MKS_ROBIN_TFT24) \
  + ENABLED(MKS_ROBIN_TFT28) \
  + ENABLED(MKS_ROBIN_TFT32) \
  + ENABLED(MKS_ROBIN_TFT35) \
  + ENABLED(MKS_ROBIN_TFT43) \
  + ENABLED(MKS_ROBIN_TFT_V1_1R) \
  + ENABLED(TFT_TRONXY_X5SA) \
  + ENABLED(ANYCUBIC_TFT35) \
...
#undef IS_ULTIPANEL
...
#if ANY(TFT_COLOR_UI, TFT_CLASSIC_UI, TFT_LVGL_UI) && 1 != ENABLED(MKS_TS35_V2_0) \
  + ENABLED(MKS_ROBIN_TFT24) \
  + ENABLED(MKS_ROBIN_TFT28) \
  + ENABLED(MKS_ROBIN_TFT32) \
  + ENABLED(MKS_ROBIN_TFT35) \
  ...
  + ENABLED(ANYCUBIC_TFT35) \
  + ENABLED(TFT_GENERIC)
  #error "Please select only at least one TFT display."
#endif

#if 1 < ENABLED(FSMC_GRAPHICAL_TFT) + ENABLED(SPI_GRAPHICAL_TFT)
...
#if 1 < ENABLED(TFT_RES_320x240) + ENABLED(TFT_RES_480x272) + ENABLED(TFT_RES_480x320)
