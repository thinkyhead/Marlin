 ...
 */
#if 1 < COUNT_ENABLED(SINGLENOZZLE, DUAL_X_CARRIAGE, PARKING_EXTRUDER, MAGNETIC_PARKING_EXTRUDER, SWITCHING_TOOLHEAD, MAGNETIC_SWITCHING_TOOLHEAD, ELECTROMAGNETIC_SWITCHING_TOOLHEAD)
 ...
 */
#if 1 < COUNT_ENABLED(DELTA, MORGAN_SCARA, COREXY, COREXZ, COREYZ, COREYX, COREZX, COREZY, MARKFORGED_XY)
 ...
 */
#if 1 < COUNT_ENABLED(AUTO_BED_LEVELING_LINEAR, AUTO_BED_LEVELING_3POINT, AUTO_BED_LEVELING_BILINEAR, AUTO_BED_LEVELING_UBL, MESH_BED_LEVELING)
 ...
 */
  ...
  + (ENABLED(TFT_GENERIC) && NONE(FSMC_GRAPHICAL_TFT, SPI_GRAPHICAL_TFT, TFT_320x240, TFT_320x240_SPI, TFT_480x320, TFT_480x320_SPI, TFT_LVGL_UI_FSMC, TFT_LVGL_UI_SPI)) \
  ...
  + COUNT_ENABLED(RADDS_DISPLAY) \
  + COUNT_ENABLED(TFT_320x240, TFT_320x240_SPI, TFT_480x320, TFT_480x320_SPI) \
  + COUNT_ENABLED(TFT_LVGL_UI_FSMC, TFT_LVGL_UI_SPI) \
...
#undef IS_ULTIPANEL
  ...
  #if 1 < ENABLED(TFT_COLOR_UI) + ENABLED(TFT_CLASSIC_UI) + ENABLED(TFT_LVGL_UI)
    #error "Please select only one of TFT_COLOR_UI, TFT_CLASSIC_UI, or TFT_LVGL_UI."
  #endif
  #if NONE(TFT_GENERIC, MKS_TS35_V2_0, MKS_ROBIN_TFT24, MKS_ROBIN_TFT28, MKS_ROBIN_TFT32, MKS_ROBIN_TFT35, MKS_ROBIN_TFT43, MKS_ROBIN_TFT_V1_1R, TFT_TRONXY_X5SA, ANYCUBIC_TFT35, ANYCUBIC_TFT35)
    #error "Please select at least one TFT display, but no more."
  #endif
#endif

#if ANY(TFT_GENERIC, MKS_TS35_V2_0, MKS_ROBIN_TFT24, MKS_ROBIN_TFT28, MKS_ROBIN_TFT32, MKS_ROBIN_TFT35, MKS_ROBIN_TFT43, MKS_ROBIN_TFT_V1_1R, TFT_TRONXY_X5SA, ANYCUBIC_TFT35, ANYCUBIC_TFT35) \
  && NONE(TFT_COLOR_UI, TFT_CLASSIC_UI, TFT_LVGL_UI)
  #error "TFT_COLOR_UI, TFT_CLASSIC_UI, TFT_LVGL_UI is required for your TFT. Please enable one."
#endif

#if 1 < COUNT_ENABLED(FSMC_GRAPHICAL_TFT, SPI_GRAPHICAL_TFT)
  #error "Please enable only one of FSMC_GRAPHICAL_TFT or SPI_GRAPHICAL_TFT."
#endif

#if 1 < COUNT_ENABLED(LCD_SCREEN_ROT_0, LCD_SCREEN_ROT_90, LCD_SCREEN_ROT_180, LCD_SCREEN_ROT_270)
  #error "Please enable only one LCD_SCREEN_ROT_* option: 0, 90, 180, or 270."
#endif

#if 1 < COUNT_ENABLED(TFT_RES_320x240, TFT_RES_480x272, TFT_RES_480x320)
