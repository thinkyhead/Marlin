...
#if ANY(HAS_TEMPERATURE, HAS_LCD_MENU, DWIN_CREALITY_LCD, DGUS_LCD_UI_CREALITY_TOUCH)
 ...
 */
  ...
  #if DISABLED(DGUS_LCD_UI_CREALITY_TOUCH) && (ANY(HAS_LCD_MENU, EXTENSIBLE_UI, DWIN_CREALITY_LCD_ENHANCED, DWIN_CREALITY_LCD_JYERSUI) || BOTH(EMERGENCY_PARSER, HOST_PROMPT_SUPPORT))
 ...
 */
  ...
  #define USE_BEEPER 1
#endif
#if ANY(USE_BEEPER, LCD_USE_I2C_BUZZER, DGUS_LCD_UI_CREALITY_TOUCH, PCA9632_BUZZER)
  #define HAS_BUZZER 1
#endif
