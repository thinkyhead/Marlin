 ...
 */
  ...
  void end_sensorless_homing_per_axis(const AxisEnum axis, sensorless_t enable_stealth);
    ...
    class Anker_TMC_SET {
    public:
      void set_tmc_x_tcoolthrs(uint32_t value);
      void set_tmc_y_tcoolthrs(uint32_t value);
      void set_tmc_z1_tcoolthrs(uint32_t value);
      #ifdef Z2_DRIVER_TYPE
       void set_tmc_z2_tcoolthrs(uint32_t value);
      #endif
