  ...
  void tmc_disable_stallguard(TMC2660Stepper, const bool);
   ...
   class Anker_TMC2209 {
     public:
      ...
      void set_tcoolthrs(TMC2209Stepper &st,uint32_t value);
      uint32_t get_tcoolthrs(TMC2209Stepper &st);
      bool tmc_enable_stallguard(TMC2209Stepper &st,uint32_t anker_thrs);
      void tmc_disable_stallguard(TMC2209Stepper &st, const bool restore_stealth);
      void tmc_set_scale(TMC2209Stepper &st,uint32_t anker_thrs);
      void tmc_set_grand(TMC2209Stepper &st,uint32_t anker_thrs);
   };
