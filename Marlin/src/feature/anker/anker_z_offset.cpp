...
int16_t Anker_Probe_set::leveling_value = LEVELING_PROBE_VALUE;
uint16_t Anker_Probe_set::delay = LEVELING_PROBE_DELAY;
...
void Anker_Probe_set::reset_value() {
  ...
  anker_probe_set.leveling_value = LEVELING_PROBE_VALUE;
}

void Anker_Probe_set::report_value() {
  SERIAL_ECHOPAIR("anker probe homing value: ", anker_probe_set.homing_value, "\r\nanker probe leveing value: ", anker_probe_set.leveling_value, "\r\n");
}
...
void Anker_Probe_set::auto_run_send_start_info() {
  ...
  SERIAL_ECHOLNPGM("auto_run_send_start_info");
}
